...
public class DefinitionOfWords {
    private  int id;
    private  String word;
    private String definition;

    public DefinitionOfWords(int id, String word, String definition) {
        this.id = id;
        this.word = word;
        this.definition = definition;
    }
    public DefinitionOfWords(){
    ...
    public boolean equals(Object o) {
        ...
        DefinitionOfWords word1 = (DefinitionOfWords) o;
